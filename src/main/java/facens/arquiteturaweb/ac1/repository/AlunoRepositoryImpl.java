...
public class AlunoRepositoryImpl implements AlunoRepository {
    ...
    public AlunoRepositoryImpl() {
        ...
        alunos.add(new Aluno(1L, "Giovani", "Francês", "19005123", "Semi-Presencial", "Masculino"));
        alunos.add(new Aluno(2L, "Arthur", "Metrologia", "19005124", "Presencial", "Não Determinado"));
        alunos.add(new Aluno(3L, "Kauan", "ADS", "19005125", "EAD", "Masculino"));
